      ...
      <h1 style={{marginBottom:'2rem'}}>How Go Fund Me works:</h1>
        ...
        <div className="row gridTable">
            <div className="col-sm-4">
                ...
                <li><a href='https://www.youtube.com/watch?v=Dcf4H8fchbE&ab_channel=gofundme'>Watch a video tutorial</a></li>
                </ul>
            </div>
            <div className="col-sm-4">
                ...
                <ul>
                    ...
                    <li><a href="https://www.youtube.com/watch?v=DWC2ClFUyvI&ab_channel=gofundme">Watch a video tutorial</a></li>
                </ul>
            </div>
            <div className="col-sm-4">
